...
{
    internal class CSUpdaterMain : ServiceControl, IDisposable
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                */
                ...
                {
                    configurator.Service<CSUpdaterMain>();
        ...
        public bool Stop(HostControl hostControl)
        {
            ...
            "CSUpdater service stop initiated".Info("Eventlog");
            ...
            {
                sw.Stop();
                $"CSUpdater service stop concluded. Stop sequence took {sw.ElapsedMilliseconds}ms".Info("Eventlog");
            }
            return true;
        }
        ...
        {
            "Starting CSUpdater service".Info("Eventlog");
            ...
            finally
            {
                ...
                $"CSUpdater service start concluded, took {sw.ElapsedMilliseconds}ms".Info("Eventlog");
            }
            return true;
        }
