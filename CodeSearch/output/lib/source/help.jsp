...
<ul>
    ...
    <li>to do a proximity search use the tilde, "~", symbol at the end of a
        Phrase. For example to search for a "codesearch" and "help" within 10
        words of each other enter: "codesearch help"~10 </li>
...
<p>Codesearch supports escaping special characters that are part of the query
...
<b>^</b> , e.g. help^4 codesearch - will make term help boosted
</p>

<p>Codesearch is powered by <a href="http://lucene.apache.org/"
>lucene</a>, for more detail on query syntax refer to <a href="http://lucene.apache.org/core/<%=SearchEngine.LUCENE_VERSION_HELP%>/queryparser/org/apache/lucene/queryparser/classic/package-summary.html#package_description">lucene docs</a>.<br>
</p>
        </div>
<%
}
