...
%>
        ...
        <div id="bar">
            ...
            <div id="sortfield" style="display:inline; padding-left:0.8cm">
                <label for="sortby">Sort by</label>
                <ul style="display:inline" id="sortby"><%
    StringBuilder url = createUrl(searchHelper, true).append("&amp;sort=");
    for (SortOrder o : SortOrder.values()) {
        if (searchHelper.order == o) {
                    %><li style="display:inline; padding-left:0.2cm; padding-right:0.2cm"><span class="active"><%= o.getDesc() %></span></li><%
        } else {
                    %><li style="display:inline; padding-left:0.2cm; padding-right:0.2cm"><a href="<%= url %><%= o %>"><%= o.getDesc() %></a></li><%
        }
    }
                %></ul>
            </div>
