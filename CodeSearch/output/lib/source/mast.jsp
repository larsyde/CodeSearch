...
<div id="bar">
    <ul style="display:inline; margin-left:5px; margin-right:5px">
        <li style="display:inline"><a href="<%= context %>/"><span id="home"></span>Home</a></li><%
    if (!cfg.hasHistory()) {
    ...
    if (!cfg.isDir()) {
        ...
        %>
	<li style="display:inline; margin-left:5px; margin-right:5px"><a href="<%= context + Prefix.RAW_P + uriEncodedPath
            + (rev.length() == 0 ? "" : "?r=" + Util.URIEncode(rev))
            %>"><span id="raw"></span>Raw</a></li>
	<li style="display:inline; margin-left:5px; margin-right:5px"><a href="<%= context + Prefix.DOWNLOAD_P + uriEncodedPath
            + (rev.length() == 0 ? "" : "?r=" + Util.URIEncode(rev))
